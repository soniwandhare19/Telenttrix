    ...
    return (
        <div>
            <section className="bg-[#dd3333] text-white py-6 md:py-10">
                <h2 className="text-center text-2xl md:text-3xl font-semibold px-4">Why Telenttrix?</h2>
            </section>
                ...
                <div className="flex flex-wrap lg:flex-nowrap justify-center gap-6 md:gap-8 lg:gap-10 max-w-6xl mx-auto">
                    {data.map((item, index) => (
                        <div
                            ...
                            <img
                                src={item.image} alt={item.title} className="w-[50px] h-[50px] object-contain"/>
