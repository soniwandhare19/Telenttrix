    ...
    <footer className="bg-black/90 text-white py-10 px-6 md:px-16 lg:px-32 flex-col justify-between">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
        ...
        <div>
         ...
         <Link to={"/careers"}><h3 className="font-medium text-[18px] mt-6 mb-4">CAREER </h3></Link> 
          <ul className="space-y-2">
          <Link to={"/careers"}> <li>Corporate Jobs</li></Link> 
          <Link to={"/careers"}> <li>Consultant Jobs</li></Link> 
          </ul>
      ...
      <div className="mt-10 pt-6 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="flex space-x-4">
            <div className="w-8 h-8 bg-white/20 hover:bg- flex items-center justify-center">  <FaLinkedin/></div>
            <div className="w-8 h-8 bg-white/20 flex items-center justify-center">  <FaFacebookF/></div>
            <div className="w-8 h-8 bg-white/20 flex items-center justify-center">  <FaXTwitter/></div>
            <div className="w-8 h-8 bg-white/20 flex items-center justify-center">  <FaInstagram/></div>
          </div>
        </div>
      </div>
